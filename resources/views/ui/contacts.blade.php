...
<html lang="en">
    <head>
        ...
        <script src="{{ asset('js/customjs/menu.js') }}"></script>
    </head>
    <body>
        <main class="contact page">
            ...
            <div class="contact_group">
                <p>Inquiries regarding website</p>
                <p>Urbnly Website</p>
                <p>TEL: 03-0404-0001</p>
                <p>10:00-20:00</p>
            </div>
            <div class="contact_group">
                <p>Press related inquiries</p>
                <p>TEL: 08-6192-8724</p>
                <p>Weekdays (excluding Fridays, Weekends, and Holidays)</p>
                <p>10:00-18:00</p>
            </div>
        </main>
        <div class="contact_menu page" id="ddmenu">
            <div class="menu_nav">
                <ul>
                    <li>
                        <a href="/">Home</a>
        ...
        <header class="ctheader">
            ...
            <button class="menubutton" onclick="menuFunction()">
                <svg class="menu" width="50" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                    <path d="M3 9a1 1 0 1 0 0 2h44a1 1 0 1 0 0-2h-44zm0 15a1 1 0 1 0 0 2h44a1 1 0 1 0 0-2h-44zm0 15a1 1 0 1 0 0 2h44a1 1 0 1 0 0-2h-44z"/>
                </svg>
            </button>
        </header>
    </body>
