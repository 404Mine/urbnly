...
class CategoryPolicy
{
     ...
     */
    public function view($customer, Category $category): bool
    {
        return $customer->isSeller() || $customer->isAdmin();
    }
     ...
     */
    public function update($customer, Category $category): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function delete($customer, Category $category): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function restore($customer, Category $category): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function forceDelete($customer, Category $category): bool
    {
        return $customer->isAdmin();
    }
