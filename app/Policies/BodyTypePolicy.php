...
class BodyTypePolicy
{
     ...
     */
    public function view($customer, BodyType $bodyType): bool
    {
        return $customer->isSeller() || $customer->isAdmin();
    }
     ...
     */
    public function update($customer, BodyType $bodyType): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function delete($customer, BodyType $bodyType): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function restore($customer, BodyType $bodyType): bool
    {
        return $customer->isAdmin();
    }
     ...
     */
    public function forceDelete($customer, BodyType $bodyType): bool
    {
        return $customer->isAdmin();
    }
